...
const PostPage = () => {
  ...
  return (
    <main className='p-3 flex flex-col max-w-6xl mx-auto min-h-screen'>
        ...
        <button className='text-gray-700 rounded-lg text-lg'>{post && post.category}</button></Link>

        <img className='mt-10 p-3 max-h-[600px] w-full object-cover' src={post && post.image} alt={post && post.title }/>
